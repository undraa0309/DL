...
Original file is located at
    https://colab.research.google.com/drive/13jMcla-exo7EfV50RHxJQCtrYRA4DENM
"""
...
import os
os.chdir('/content/drive/MyDrive/mnist-classification/data')
...
if __name__ == '__main__':
    ...
    train = MNIST(data_dir='/content/drive/MyDrive/mnist-classification/data/train.tar', transform=transform, is_train=True)
    test = MNIST(data_dir='/content/drive/MyDrive/mnist-classification/data/test.tar', transform=transform, is_train=False)
